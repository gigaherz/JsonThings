...
public class UnaryConversion<R, T, B> extends ValueExpression<R,B>
{
    private final TypeToken<R> targetType;
    private final int opcode;
    private final ValueExpression<T,B> value;

    public UnaryConversion(CodeBlock<B,?,?> cb, TypeToken<R> targetType, int opcode, ValueExpression<T,B> value)
    {
        super(cb);
