...
public class FlexAxeItem extends AxeItem implements IEventRunner
{
    public FlexAxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Properties properties, ItemBuilder builder)
    {
