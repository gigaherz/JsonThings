...
{
    public FlexDiggerItem(ToolMaterial material, float attackDamage, float attackSpeed, TagKey<Block> breakable, Properties properties, ItemBuilder builder)
    {
        super(material, breakable, attackDamage, attackSpeed, properties);
