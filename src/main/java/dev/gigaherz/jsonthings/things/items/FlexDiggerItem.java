...
public class FlexDiggerItem extends ToolItem implements IFlexItem
{
    public FlexDiggerItem(IItemTier material, float damage, float speed, Properties properties)
    {
        super(damage, speed, material, Collections.emptySet(), properties);
        initializeFlex();
    }
