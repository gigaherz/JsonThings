...
public class FlexSwordItem extends SwordItem implements IEventRunner
{
    public FlexSwordItem(ToolMaterial material, float attackDamage, float attackSpeed, Properties properties, ItemBuilder builder)
    {
