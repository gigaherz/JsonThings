...
public interface DefineMethod<C, R> extends Implementable<C, MethodInfo>, Annotatable<DefineMethod<C, R>>
{
    ...
    public interface DefineArgs5<C, R, P0, P1, P2, P3, P4> extends DefineParam<C, P4, DefineArgs5<C, R, P0, P1, P2, P3, P4>>
    {
    ...
    public interface DefineArgs6<C, R, P0, P1, P2, P3, P4, P5> extends DefineParam<C, P5, DefineArgs6<C, R, P0, P1, P2, P3, P4, P5>>
    {
    ...
    public interface DefineArgs7<C, R, P0, P1, P2, P3, P4, P5, P6> extends DefineParam<C, P6, DefineArgs7<C, R, P0, P1, P2, P3, P4, P5, P6>>
    {
    ...
    public interface DefineArgs8<C, R, P0, P1, P2, P3, P4, P5, P6, P7> extends DefineParam<C, P7, DefineArgs8<C, R, P0, P1, P2, P3, P4, P5, P6, P7>>
    {
