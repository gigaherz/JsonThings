...
public class ItemFlexPlantFood extends ItemSeedFood implements IFlexItem
{
    public ItemFlexPlantFood(int healAmount, float saturation, Block crops, Block soil)
    {
