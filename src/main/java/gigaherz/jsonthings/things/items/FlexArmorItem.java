...
{
    public FlexArmorItem(IArmorMaterial material, EquipmentSlotType slot, Item.Properties properties)
    {
        ...
        eventHandlers.put("use_on_air", (eventName, context) ->
                super.use(context.get(FlexEventContext.WORLD), (PlayerEntity) context.get(FlexEventContext.USER), context.get(FlexEventContext.HAND)));
    }
