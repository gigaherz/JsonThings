...
import gigaherz.jsonthings.util.parse.function.ArrayValueFunction;
import gigaherz.jsonthings.util.parse.function.IntObjBiConsumer;
import gigaherz.jsonthings.util.parse.function.JsonArrayConsumer;
import gigaherz.jsonthings.util.parse.function.JsonArrayFunction;
